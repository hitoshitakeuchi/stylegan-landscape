...
def main():
    ...
    parser.add_argument('--iterations', default=10000, help='Number of optimization steps for each batch', type=int)
    ...
    tflib.init_tf()
    with open('./cache/landscape.pkl', 'rb') as fp:
        generator_network, discriminator_network, Gs_network = pickle.load(fp)
